...
@section('scripts')
    ...
    <script>
                            ...
                            columns: [{
                                ...
                                },
                                {
                                    ...
                                    render: function(data, type, row) {
                                        let editUrl =
                                            `{{ url('admin/manage-user') }}/${row.id}/edit`;
                                        return `
                                    <a href="${editUrl}" class="btn btn-sm btn-warning"><i class="ph-pencil-line"></i></a>
                                    <button onclick="deleteUser('${row.id}')" class="btn btn-sm btn-danger"><i class="ph-trash"></i></button>
                                `;
                                    },
                                    orderable: false,
                                    searchable: false
        ...
        function edit(id) {
            $.ajax({
                type: "GET",
                url: "{{ url('admin/manage-user') }}/" + id + "/edit",
                dataType: "html",
                success: function(data) {
                    $('#content-modal-ce').html(data);
                    $('#modal-ce').modal('show');
